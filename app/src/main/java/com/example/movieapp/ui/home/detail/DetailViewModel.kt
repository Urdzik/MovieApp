...
@HiltViewModel
class DetailViewModel @Inject constructor(private val movieDetailSource: MovieListSource) :
  ViewModel() {
  ...
  fun getSelectedMovieById(id: Int) {
    viewModelScope.launch {
      _selectProperty.postValue(movieDetailSource.fetchDetailInformationOfMovie(id))
    }
